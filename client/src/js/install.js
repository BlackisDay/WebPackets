...
window.addEventListener('beforeinstallprompt', (event) => {
    window.deferredPrompt = event; // sets deferredPrompt to event, which is the event that was triggered, which is the prompt, which is the install prompt, which is the deferred prompt
